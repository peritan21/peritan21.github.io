...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        __WEBPACK_IMPORTED_MODULE_1_firebase__["initializeApp"]({
            apiKey: 'AIzaSyDpLWokv7Av0Woa8ENAFToHKib_qNXS71U',
            authDomain: 'ng-recipe-book-90e68.firebaseapp.com'
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__shopping_list_shoping_edit_shoping_edit_component__ = __webpack_require__("../../../../../src/app/shopping-list/shoping-edit/shoping-edit.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__shared_dropdowndirective__ = __webpack_require__("../../../../../src/app/shared/dropdowndirective.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__shopping_list_shoping_list_service__ = __webpack_require__("../../../../../src/app/shopping-list/shoping-list.service.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_9__shopping_list_shoping_edit_shoping_edit_component__["a" /* ShopingEditComponent */],
            __WEBPACK_IMPORTED_MODULE_10__shared_dropdowndirective__["a" /* DropdownDirective */],
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_11__shopping_list_shoping_list_service__["a" /* ShopingListService */], __WEBPACK_IMPORTED_MODULE_17__recipes_recipe_service__["a" /* RecipeService */], __WEBPACK_IMPORTED_MODULE_18__shared_data_storage_service__["a" /* DataStorageService */], __WEBPACK_IMPORTED_MODULE_21__auth_auth_service__["a" /* AuthSerice */], __WEBPACK_IMPORTED_MODULE_22__auth_auth_guard_service__["a" /* AuthGuard */]],
...
AuthGuard = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__auth_service__["a" /* AuthSerice */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__auth_service__["a" /* AuthSerice */]) === "function" && _a || Object])
], AuthGuard);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AuthSerice; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthSerice = (function () {
    function AuthSerice(router) {
        this.router = router;
    }
    AuthSerice.prototype.signupUser = function (email, password) {
        __WEBPACK_IMPORTED_MODULE_1_firebase__["auth"]().createUserWithEmailAndPassword(email, password)
            .catch(function (error) { return console.log(error); });
    };
    AuthSerice.prototype.signinUser = function (email, password) {
        var _this = this;
    ...
    AuthSerice.prototype.logout = function () {
        __WEBPACK_IMPORTED_MODULE_1_firebase__["auth"]().signOut();
        this.token = null;
    };
    AuthSerice.prototype.getToken = function () {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_1_firebase__["auth"]().currentUser.getToken()
            .then(function (token) { return _this.token = token; });
        return this.token;
    };
    AuthSerice.prototype.isAuthenticated = function () {
        return this.token != null;
    };
    return AuthSerice;
}());
AuthSerice = __decorate([
...
HeaderComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__shared_data_storage_service__["a" /* DataStorageService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__shared_data_storage_service__["a" /* DataStorageService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__auth_auth_service__["a" /* AuthSerice */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__auth_auth_service__["a" /* AuthSerice */]) === "function" && _b || Object])
], HeaderComponent);
...
var RecipeDetailComponent = (function () {
    ...
    RecipeDetailComponent.prototype.onAddToShopingList = function () {
...
var RecipeListComponent = (function () {
    ...
    RecipeListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.subsciption = this.recipeService.recipedChanged
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shopping_list_shoping_list_service__ = __webpack_require__("../../../../../src/app/shopping-list/shoping-list.service.ts");
...
var RecipeService = (function () {
    function RecipeService(slService) {
        ...
        this.recipedChanged = new __WEBPACK_IMPORTED_MODULE_4_rxjs_Subject__["Subject"]();
        this.recipes = [
            new __WEBPACK_IMPORTED_MODULE_0__recipe_model__["a" /* Recipe */]('the test recipe', 'a sumple recipe', 'http://ichef.bbci.co.uk/food/ic/food_16x9_88/recipes/chicken_and_vegetable_65850_16x9.jpg', [
                new __WEBPACK_IMPORTED_MODULE_2__shared_ingredient_model__["a" /* Ingredient */]('Meat', 1),
                new __WEBPACK_IMPORTED_MODULE_2__shared_ingredient_model__["a" /* Ingredient */]('French meat', 10)
            ]),
            new __WEBPACK_IMPORTED_MODULE_0__recipe_model__["a" /* Recipe */]('my recipe', 'a my sumple recipe', 'https://www.bbcgoodfood.com/sites/default/files/styles/teaser_item/public/recipe_images/recipe-image-legacy-id--932456_11.jpg?itok=nszDU2JG', [
                new __WEBPACK_IMPORTED_MODULE_2__shared_ingredient_model__["a" /* Ingredient */]('Buns', 2),
                new __WEBPACK_IMPORTED_MODULE_2__shared_ingredient_model__["a" /* Ingredient */]('Meat', 5)
            ])
        ];
    }
    ...
    RecipeService.prototype.addIngredientsToShopingList = function (ingredients) {
...
RecipeService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__shopping_list_shoping_list_service__["a" /* ShopingListService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__shopping_list_shoping_list_service__["a" /* ShopingListService */]) === "function" && _a || Object])
], RecipeService);
...
var DataStorageService = (function () {
    ...
    DataStorageService.prototype.storeRecipes = function () {
        ...
        return this.http.put('https://ng-recipe-book-90e68.firebaseio.com/recipes.json?auth=' + token, this.recipeService.getRecipes());
    };
    DataStorageService.prototype.getRecipes = function () {
        var _this = this;
        var token = this.authService.getToken();
        this.http.get('https://ng-recipe-book-90e68.firebaseio.com/recipes.json?auth=' + token)
...
/***/ "../../../../../src/app/shared/dropdowndirective.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "../../../../../src/app/shopping-list/shoping-edit/shoping-edit.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/shopping-list/shoping-edit/shoping-edit.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"row\">\n   <div class=\"col xs-12\">\n     <form (ngSubmit)=\"onSubmit(f)\" #f=\"ngForm\">\n        <div class=\"row\">\n            <div class=\"col-sm-5 form-group\">\n              <label for=\"name\">Name</label>\n              <input\n                type=\"text\"\n                id=\"name\"\n                class=\"form-control\"\n                name=\"name\"\n                ngModel\n                required\n              >\n            </div>\n\n            <div class=\"col-sm-2 form-group\">\n               <label for=\"amount\">Amount</label>\n               <input\n                 type=\"number\"\n                 id=\"amount\"\n                 class=\"form-control\"\n                 name=\"amount\"\n                 ngModel\n                 required\n                 pattern=\"^[1-9]+[0-9]*$\"\n               >\n            </div>\n        </div>\n       <div class=\"row\">\n         <div class=\"col-xs-12\">\n           <button\n             class=\"btn btn-success\"\n             type=\"submit\" [disabled]=\"!f.valid\">{{editMode ? 'Update': 'Add' }}\n           </button>\n           <button\n             class=\"btn btn-danger\"\n             type=\"button\"\n             (click)=\"onDelete()\"\n             *ngIf=\"editMode\">Delete</button>\n           <button class=\"btn btn-primary\" type=\"button\" (click)=\"onClear()\">Clear</button>\n         </div>\n       </div>\n     </form>\n   </div>\n</div>\n"

/***/ }),

/***/ "../../../../../src/app/shopping-list/shoping-edit/shoping-edit.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_ingredient_model__ = __webpack_require__("../../../../../src/app/shared/ingredient.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shoping_list_service__ = __webpack_require__("../../../../../src/app/shopping-list/shoping-list.service.ts");
...
var ShopingEditComponent = (function () {
    function ShopingEditComponent(slService) {
        this.slService = slService;
        this.editMode = false;
    }
    ...
    ShopingEditComponent.prototype.onSubmit = function (form) {
    ...
    ShopingEditComponent.prototype.onClear = function () {
        this.slForm.reset();
        this.editMode = false;
    };
    ShopingEditComponent.prototype.onDelete = function () {
        this.slService.deleteIngredient(this.editedItemIndex);
        this.onClear();
    };
    ShopingEditComponent.prototype.ngOnDestroy = function () {
...
], ShopingEditComponent.prototype, "slForm", void 0);
ShopingEditComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* Component */])({
        selector: 'app-shoping-edit',
        template: __webpack_require__("../../../../../src/app/shopping-list/shoping-edit/shoping-edit.component.html"),
        styles: [__webpack_require__("../../../../../src/app/shopping-list/shoping-edit/shoping-edit.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__shoping_list_service__["a" /* ShopingListService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__shoping_list_service__["a" /* ShopingListService */]) === "function" && _b || Object])
], ShopingEditComponent);

var _a, _b;
//# sourceMappingURL=shoping-edit.component.js.map

/***/ }),

/***/ "../../../../../src/app/shopping-list/shoping-list.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ShopingListService; });


var ShopingListService = (function () {
    function ShopingListService() {
        this.ingredientsChanched = new __WEBPACK_IMPORTED_MODULE_1_rxjs_Subject__["Subject"]();
        ...
        this.ingradients = [
            ...
            new __WEBPACK_IMPORTED_MODULE_0__shared_ingredient_model__["a" /* Ingredient */]('Tomates', 10)
        ];
    }
    ShopingListService.prototype.getIngredients = function () {
        return this.ingradients.slice();
    };
    ShopingListService.prototype.getIngredient = function (index) {
        return this.ingradients[index];
    };
    ShopingListService.prototype.addIngredient = function (ingredient) {
        this.ingradients.push(ingredient);
        this.ingredientsChanched.next(this.ingradients.slice());
    };
    ShopingListService.prototype.addIngredients = function (ingredients) {
        (_a = this.ingradients).push.apply(_a, ingredients);
        this.ingredientsChanched.next(this.ingradients.slice());
        var _a;
    };
    ShopingListService.prototype.updateIngredient = function (index, newIngredient) {
        this.ingradients[index] = newIngredient;
        this.ingredientsChanched.next(this.ingradients.slice());
    };
    ShopingListService.prototype.deleteIngredient = function (index) {
        this.ingradients.splice(index, 1);
        this.ingredientsChanched.next(this.ingradients.slice());
    };
    return ShopingListService;
}());

//# sourceMappingURL=shoping-list.service.js.map
...
module.exports = "<div class=\"row\">\n    <div class=\"col-xs-10\">\n      <app-shoping-edit></app-shoping-edit>\n      <hr>\n     <ul class=\"list-group\">\n       <a\n         class=\"list-group-item\"\n         style=\"cursor: pointer\"\n         *ngFor=\"let ingredient of ingradients; let i=index\"\n         (click)=\"onEditItem(i)\"\n       >\n         {{ ingredient.name }} ({{ ingredient.amount }})\n       </a>\n     </ul>\n    </div>\n</div>\n"
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shoping_list_service__ = __webpack_require__("../../../../../src/app/shopping-list/shoping-list.service.ts");
...
var ShoppingListComponent = (function () {
    ...
    ShoppingListComponent.prototype.ngOnInit = function () {
        ...
        this.subscription = this.slService.ingredientsChanched
            .subscribe(function (ingredients) {
            _this.ingradients = ingredients;
        });
    };
...
ShoppingListComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__shoping_list_service__["a" /* ShopingListService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__shoping_list_service__["a" /* ShopingListService */]) === "function" && _a || Object])
